...
packages=(
    ...
    ["tweaks"]="telegram-purple  pcmanfm plank thunar-dropbox-plugin guake oracle-java8-installer synapse ncurses-term lm-sensors hddtemp tlp tlp-rdw tp-smapi-dkms smartmontools ethtool skype"
